      ...
      <div class="row align-items-center">
        <div class="col-12 col-sm-6">
          <div class="hero-content">
            ...
            <a class="hero-button" target="_unblank" href="{{ config('app.info.memberformlink') }}"><i class="fa fa-users"></i> View Our Chapter</a>
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="card">
            <div class="card-body">
              ...
              <p>We hold workshops and showcases at SJCET PALAI & we would recommend you to join our community by becoming a <a href="{{ config('app.info.memberformlink') }}" >member</a> to get updates.</p>
            </div>
          </div>
        </div>
      </div>
